...
import br.com.pitanga.table.cellrenderer.FormaPagamentoCellRenderer;
import br.com.pitanga.table.model.FormaPagamentoTableModel;
...
public class FrmFormaPagamento extends javax.swing.JDialog {
    ...
    List<FormaPagamento> formas = null;
     ...
     * @param modal
     */
    public FrmFormaPagamento(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializarFrame();
    }
    ...
    private void inicializarFrame() {
        ...
        this.tbFormaPagamento.setEnabled(true);
        // Habilita a seleção na tabela
        this.tbFormaPagamento.setRowSelectionAllowed(true);
        ...
        this.setTitle("Pitanga System - Formas de Pagamento");
        // Habilita o Enter como TAB, passando o Componente
        GUIUtils.considerarEnterComoTab(this);
    }

    private void preencherTabela() {
        this.formas = preencherFormas();
        if (this.formas != null) {
            this.tbFormaPagamento.setModel(new FormaPagamentoTableModel(this.formas));
            this.tbFormaPagamento.setDefaultRenderer(Object.class, new FormaPagamentoCellRenderer());
        }
    }

    private List<FormaPagamento> preencherFormas() {
        
        List<FormaPagamento> lista = new ArrayList<>();
        FormaPagamentoDAO tpd = DAOFactory.getDefaultDAOFactory().getFormaPagamentoDAO();
    ...
    private void acaoNovo() {
        ...
        // Tabela
        this.tbFormaPagamento.setEnabled(false);
        this.tbFormaPagamento.setRowSelectionAllowed(false);
        // Campos
    ...
    private void acaoGravar() {
        ...
        forma.setDescricao(this.tfDescricao.getText().trim());

        FormaPagamentoDAO fpDao = DAOFactory.getDefaultDAOFactory().getFormaPagamentoDAO();
        fpDao.inserir(forma);
